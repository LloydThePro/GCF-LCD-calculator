...
#define WIN_COL_RED vec3col(1.0f, 0.0f, 0.0f)
#define WIN_COL_BLUE vec3col(0.0f, 0.0f, 1.0f)
#define WIN_COL_GREEN vec3col(0.0f, 1.0f, 0.0f)
...
public:
	...
	void CreateBitMapImg(unsigned int width, unsigned int heigth, int x, int y, const char * filename);
